...
class BuysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post buys_url, params: { buy: { body: @buy.body, image: @buy.image, price: @buy.price, title: @buy.title } }
    end
  ...
  test "should update buy" do
    patch buy_url(@buy), params: { buy: { body: @buy.body, image: @buy.image, price: @buy.price, title: @buy.title } }
