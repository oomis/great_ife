...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { body: @rent.body, image: @rent.image, price: @rent.price, title: @rent.title } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { body: @rent.body, image: @rent.image, price: @rent.price, title: @rent.title } }
