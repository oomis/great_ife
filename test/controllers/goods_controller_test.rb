...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post goods_url, params: { good: { body: @good.body, price: @good.price, title: @good.title, user_id: @good.user_id } }
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { body: @good.body, price: @good.price, title: @good.title, user_id: @good.user_id } }
